...
impl ScriptListApp {
    ...
    pub(crate) fn spawn_open_actions_window(
        cx: &mut Context<Self>,
        placement: crate::actions::ActionsWindowPlacement,
    ...
    pub(crate) fn toggle_actions(&mut self, cx: &mut Context<Self>, window: &mut Window) {
        ...
        if self.show_actions_popup || is_actions_window_open() {
            ...
            let agent_chat_context = if let AppView::AgentChatView { ref entity } =
                self.current_view
            {
    ...
    pub fn toggle_chat_actions(&mut self, cx: &mut Context<Self>, window: &mut Window) {
        ...
        if self.show_actions_popup || is_actions_window_open() {
            ...
            let (chat_info, chat_command_bindings) =
...
#[cfg(test)]
include!("actions_toggle_tests.rs");
