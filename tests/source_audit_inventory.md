...
|---|---:|---:|---|
| `app-source-audit` | 386 | 2670 | Reads or walks `src/**`; guarded against additions |
...
| `other-repo-artifact-reader` | 115 | 321 | Reads scripts, workflows, assets, or other non-app files |
| `meta-ratchet` | 1 | 4 | Reads test source for the existing occurrence-count ratchet |
| **All readers** | **445** | **3166** | Of 540 Rust files under `tests/` |
